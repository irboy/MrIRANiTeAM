...
local settings = data[tostring(GP_id)]["settings"]
 ...
 text = '_Welcome To_ *More Settings*'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> Flood Sensitivity ', callback_data = 'MrIRANiTeAM'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="MrIRANiTeAM"},
			{text = "➖", callback_data='/flooddown:'..GP_id}
		},
		{
			{text = '> Character Sensitivity ', callback_data = 'MrIRANiTeAM'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="MrIRANiTeAM"},
			{text = "➖", callback_data='/chardown:'..GP_id}
		},
		{
			{text = '> Flood Check Time ', callback_data = 'MrIRANiTeAM'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="MrIRANiTeAM"},
 ...
 text = '_به تنظیمات بیشتر خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = '> حداکثر پیام های مکرر ', callback_data = 'MrIRANiTeAM'}
		},
		{
			{text = "➕", callback_data='/floodup:'..GP_id}, 
			{text = tostring(settings.num_msg_max), callback_data="MrIRANiTeAM"},
		...
		{
			{text = '> حداکثر حروف مجاز ', callback_data = 'MrIRANiTeAM'}
		},
		{
			{text = "➕", callback_data='/charup:'..GP_id}, 
			{text = tostring(settings.set_char), callback_data="MrIRANiTeAM"},
		...
		{
			{text = '> زمان بررسی پیام های مکرر ', callback_data = 'MrIRANiTeAM'}
		},
		{
			{text = "➕", callback_data='/floodtimeup:'..GP_id}, 
			{text = tostring(settings.time_check), callback_data="MrIRANiTeAM"},
...
local lang = redis:get(hash) 
 ...
 text = '_Welcome To_ *Group Settings*'
	...
	keyboard.inline_keyboard = {
		...
		{
			{text = "> Group Welcome", callback_data='MrIRANiTeAM'}, 
 ...
 text = '_به تنظیمات گروه خوش آمدید_'
	...
	keyboard.inline_keyboard = {
		{
			{text = "> قفل ویرایش", callback_data='MrIRANiTeAM'}, 
			{text = lock_edit, callback_data="/lockedit:"..GP_id}
		},
		{
			{text = "> قفل لینک", callback_data='MrIRANiTeAM'}, 
			{text = lock_link, callback_data="/locklink:"..GP_id}
		},
		{
			{text = "> قفل هشتگ", callback_data='MrIRANiTeAM'}, 
			{text = lock_hashtags, callback_data="/lockhashtags:"..GP_id}
		},
		{
			{text = "> قفل ورود", callback_data='MrIRANiTeAM'}, 
			{text = lock_join, callback_data="/lockjoin:"..GP_id}
		},
		{
			{text = "> قفل پیام های مکرر", callback_data='MrIRANiTeAM'}, 
			{text = lock_flood, callback_data="/lockflood:"..GP_id}
		},
		{
			{text = "> قفل هرزنامه", callback_data='MrIRANiTeAM'}, 
			{text = lock_spam, callback_data="/lockspam:"..GP_id}
		},
		{
			{text = "> قفل فراخوانی", callback_data='MrIRANiTeAM'}, 
			{text = lock_mention, callback_data="/lockmention:"..GP_id}
		},
		{
			{text = "> قفل فارسی", callback_data='MrIRANiTeAM'}, 
			{text = lock_arabic, callback_data="/lockarabic:"..GP_id}
		},
		{
			{text = "> قفل انگلیسی", callback_data='MrIRANiTeAM'}, 
			{text = english, callback_data="/lockeng:"..GP_id}
		},
		{
			{text = "> قفل صفحات وب", callback_data='MrIRANiTeAM'}, 
			{text = lock_webpage, callback_data="/lockwebpage:"..GP_id}
		},
		{
			{text = "> قفل فونت", callback_data='MrIRANiTeAM'}, 
			{text = lock_markdown, callback_data="/lockmarkdown:"..GP_id}
		},
		{
			{text = "> قفل سنجاق کردن", callback_data='MrIRANiTeAM'}, 
			{text = lock_pin, callback_data="/lockpin:"..GP_id}
		},
		{
			{text = "> قفل ربات ها", callback_data='MrIRANiTeAM'}, 
			{text = lock_bots, callback_data="/lockbots:"..GP_id}
		},
		...
		{
			{text = "> قفل فحش", callback_data='MrIRANiTeAM'}, 
			{text = fosh, callback_data="/lockfosh:"..GP_id}
		},
		{
			{text = "> قفل تبلیغات", callback_data='MrIRANiTeAM'}, 
			{text = ads, callback_data="/lockads:"..GP_id}
		},
		{
			{text = "> قفل تبچی", callback_data='MrIRANiTeAM'}, 
			{text = lock_tabchi, callback_data="/locktabchi:"..GP_id}
		},
		{
			{text = "> قفل یوزرنیم", callback_data='MrIRANiTeAM'}, 
			{text = lock_username, callback_data="/lockusername:"..GP_id}
		},
		{
			{text = "> قفل اموجی", callback_data='MrIRANiTeAM'}, 
			{text = emoji, callback_data="/lockemoji:"..GP_id}
		},
		{
			{text = "> قفل بنر", callback_data='MrIRANiTeAM'}, 
			{text = views, callback_data="/lockviews:"..GP_id}
		},
		...
		{
			{text = "> خوشآمد گویی", callback_data='MrIRANiTeAM'}, 
			{text = group_welcone, callback_data="/welcome:"..GP_id}
		},
		{
...
local lang = redis:get(hash) 
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> بیصدا همه", callback_data='MrIRANiTeAM'}, 
			{text = mute_all, callback_data="/muteall:"..GP_id}
		},
		{
			{text = "> بیصدا تصاویر متحرک", callback_data='MrIRANiTeAM'}, 
			{text = mute_gif, callback_data="/mutegif:"..GP_id}
		},
		{
			{text = "> بیصدا متن", callback_data='MrIRANiTeAM'}, 
			{text = mute_text, callback_data="/mutetext:"..GP_id}
		},
		{
			{text = "> بیصدا اینلاین", callback_data='MrIRANiTeAM'}, 
			{text = mute_inline, callback_data="/muteinline:"..GP_id}
		},
		{
			{text = "> بیصدا بازی", callback_data='MrIRANiTeAM'}, 
			{text = mute_game, callback_data="/mutegame:"..GP_id}
		},
		{
			{text = "> بیصدا عکس", callback_data='MrIRANiTeAM'}, 
			{text = mute_photo, callback_data="/mutephoto:"..GP_id}
		},
		{
			{text = "> بیصدا فیلم", callback_data='MrIRANiTeAM'}, 
			{text = mute_video, callback_data="/mutevideo:"..GP_id}
		},
		{
			{text = "> بیصدا آهنگ", callback_data='MrIRANiTeAM'}, 
			{text = mute_audio, callback_data="/muteaudio:"..GP_id}
		},
		{
			{text = "> بیصدا صدا", callback_data='MrIRANiTeAM'}, 
			{text = mute_voice, callback_data="/mutevoice:"..GP_id}
		},
		{
			{text = "> بیصدا استیکر", callback_data='MrIRANiTeAM'}, 
			{text = mute_sticker, callback_data="/settingsticker:"..GP_id}
		},
		{
			{text = "> بیصدا مخاطب", callback_data='MrIRANiTeAM'}, 
			{text = mute_contact, callback_data="/mutecontact:"..GP_id}
		},
		{
			{text = "> بیصدا نقل و قول", callback_data='MrIRANiTeAM'}, 
			{text = settings.mute_forward, callback_data="/muteforward:"..GP_id}
		},
		{
			{text = "> بیصدا موقعیت", callback_data='MrIRANiTeAM'}, 
			{text = mute_location, callback_data="/mutelocation:"..GP_id}
		},
		{
			{text = "> بیصدا فایل", callback_data='MrIRANiTeAM'}, 
			{text = mute_document, callback_data="/mutedocument:"..GP_id}
		},
		{
			{text = "> بیصدا خدمات تلگرام", callback_data='MrIRANiTeAM'}, 
			{text = mute_tgservice, callback_data="/mutetgservice:"..GP_id}
		},
		{
			{text = "> بیصدا کیبورد", callback_data='MrIRANiTeAM'}, 
			{text = mute_keyboard, callback_data="/mutekeyboard:"..GP_id}
		},
		{
			{text = '> بازگشت ', callback_data = '/option:'..GP_id}
...
local keyboard = {} 
		...
		edit_inline(msg.message_id, text, keyboard)
         ...
         -- ####################### About Us ####################### --
if matches[1] == '/IRANB0Y' then
	local text = _config.info_text
    if not lang then
	keyboard = {} 
	keyboard.inline_keyboard = {
		{
			{text = "> MRIRANI", callback_data="/IRANB0Y:"..matches[2]}
		},
		{
			{text = "> IRANB0Y", callback_data="/IRANB0Y:"..matches[2]}
		},
		{
			{text = '> Our GitHub ', url = 'https://www.github.com/IRANB0Y'}
		},
		{
   ...
   elseif lang then
	...
	keyboard.inline_keyboard = {
		{
			{text = "> رامین", callback_data="/IRANB0Y:"..matches[2]}
		},
		{
			{text = "> مستر ایرانی", callback_data="/IRANB0Y:"..matches[2]}
		},
		{
			{text = '> گیت هاب تیم ', url = 'https://www.github.com/IRANB0Y'}
		},
		{
...
if matches[1] == '/MRIRANI' then
local text = [[*》MRIRANI Information《*
_》Age :_ *23*
_》Name :_ *mr IRANI*
_》City :_ *IR - IR*
*-------------------------*
*》GitHub :《*
》[iranb0y](Github.Com/iranb0y)
*-------------------------*
*》Bridges :《*
_》Pv : _[iranb0y](Telegram.Me/iranb0y)
_》PvResan : _[iranb0y PvResan](Telegram.Me/IRANB0Ybot)
*-------------------------*
*》Expertise :《*
...
*-------------------------*]]
  if not lang then
		...
		keyboard.inline_keyboard = {
			{
				{text = "> Back 🔙", callback_data="/IRANB0Y:"..matches[2]}
			}
		}
  elseif lang then
		keyboard = {} 
		keyboard.inline_keyboard = {
			{
				{text = "> بازگشت 🔙", callback_data="/IRANB0Y:"..matches[2]}
			}
		}
  end
    edit_inline(msg.message_id, text, keyboard)
...
if matches[1] == '/IRANB0Y' then
local text = [[*》IRANB0Ybot Information《*
			》Age : *16*
			》Name : *Unknown*
			》City : *Yazd - Yazd*
			*-------------------------*
			*》Bridges《*
			》Pv : [@IRANB0Ybot](Telegram.Me/IRANB0Ybot)
			》PvResan : [@IRANB0Ybot](Telegram.Me/IRANB0Ybot)
			*-------------------------*
			*》Expertise《*
			》*C#* and a bit *C++*
			*-------------------------*]]
